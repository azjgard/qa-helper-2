...
global.addBug = new function(){
  ...
  // fix the tags that got cut off
        ...
        if (typeof $correct_content_qa === 'undefined') {
          alert('Something went wrong. Are the Course and Feature tabs open?');
        }
        else {
...
//*************************************************************************************************************
//*************************************************************************************************************
// This addBug function tried to implement the scrolling of the tfs page
